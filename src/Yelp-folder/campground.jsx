...
// import Search from '../Yelp-folder/img/Search-icon.svg'
...
function Campground() {
    ...
    return(
        ...
        <div className="navBar">
            ...
            <ul>
                <li>John doe</li>
                <li className='link' style={{marginLeft: '22px'}}><Link to='/'>Log out</Link></li>
            </ul>
        </div>
        ...
        <div className="my-images">
           ...
           <Link to='/home'> <button>View Campground</button></Link>
            </div>
